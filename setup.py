...
# Changed name of package to allow for simultaneous installation.

from setuptools import setup, find_packages

setup(
    name="ubody_controller",
    version='0.1.0',
    ...
    description="A new tool for operating Dynamixel series motors with added support for sensing capabilities!",
    long_description=open('README.md').read(),
    long_description_content_type='text/markdown',
    download_url='https://github.com/Jyumpp/ubody-controller/archive/ubody_controller-0.1.0.tar.gz',
